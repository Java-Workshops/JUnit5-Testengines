package com.svenruppert.junit.engine.micro;
...
public class MicroEngine
  ...
  private void appendTestInPackage(String packageName, EngineDescriptor rootNode) {
    ReflectionSupport
        .findAllClassesInPackage(packageName, isTestClass(), name -> true)
        .stream()
        ...
        .addSelectorResolver(context -> {
          ...
          return new SelectorResolver() {
            ...
            public Resolution resolve(ClassSelector selector, Context context) {
              String className = selector.getJavaClass().getName();
            ...
            private Resolution resolveTestClass(Class<?> testClass,
                                                Context context) {
              return context
                  .addToParent(parent -> Optional.of(
                      new MicroEngineClassTestDescriptor(testClass, parent.getUniqueId())))
