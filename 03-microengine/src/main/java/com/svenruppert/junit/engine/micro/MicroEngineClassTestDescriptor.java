...
import static com.svenruppert.junit.engine.micro.MicroEngine.isTestMethod;
...
public class MicroEngineClassTestDescriptor
  ...
  public MicroEngineClassTestDescriptor(Class<?> testClass, UniqueId uniqueId) {
    super(uniqueId.append("class", testClass.getSimpleName()),
  ...
  private void addChildren() {
    AnnotationSupport
        .findAnnotation(testClass, MicroTestClass.class)
        .ifPresent(a -> {
